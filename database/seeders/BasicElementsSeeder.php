...
class BasicElementsSeeder extends Seeder
{
    public function run(): void
    {
        $basicElements = [
            ...
            // IMAGE
            // ============================================
            // MEDIA ELEMENTS REMOVED
            // ============================================
            // Image, Video, Audio, GIF, Icon moved to AssetsPanel and IconModal
            // These are no longer in ComponentsPanel to avoid duplication
            // Access media via AssetsPanel, icons via IconModal (Lucide, Hero, Custom SVG)
        ];
