...
return new class extends Migration {
    public function up(): void {
        Schema::create('frames', function (Blueprint $table) {
            ...
            $table->json('canvas_style')->nullable()->after('canvas_data');
            $table->json('canvas_props')->nullable()->after('canvas_style');
            $table->json('canvas_animation')->nullable()->after('canvas_props');
