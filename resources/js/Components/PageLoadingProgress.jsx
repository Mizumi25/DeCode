...
const PageLoadingProgress = ({ isLoading, progress = 0, message = 'Loading...' }) => {
  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center bg-[var(--color-bg)]/95 backdrop-blur-sm pointer-events-none transition-opacity duration-300">
